...
void makePlots(bool doMultipliers)
{
  ...
  //leg->AddEntry(" ","Lead of Target 3");
  leg->Draw("SAME");
    gc->Print(doMultipliers ? "nu-2d-unfolded-model-Tracker-Ehad-multiplier.png" : "nu-2d-unfolded-Tracker-model-Ehad.png");
  ...
  gc2->Print(doMultipliers ? "nu-2d-unfolded-Tracker-model-Emu-multiplier.png" : "nu-2d-unfolded-Tracker-model-Emu.png");
