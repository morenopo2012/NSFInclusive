...
void makePlots(bool doMultipliers)
{
  ...
  //leg->AddEntry(" ","Lead of Target 3");
  leg->Draw("SAME");
    gc->Print(doMultipliers ? "nu-2d-effCorrected-model-Ehad-multiplier.png" : "nu-2d-effCorrected-model-Ehad.png");
  ...
  gc2->Print(doMultipliers ? "nu-2d-effCorrected-model-Emu-multiplier.png" : "nu-2d-effCorrected-model-Emu.png");
