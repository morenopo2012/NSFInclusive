...
void makePlots(bool doMultipliers)
{
  ...
  //need pzmuptmu
  MnvH2D* mcMnv=(MnvH2D*)f1.Get("h_mc_Emu_Ehad_unfolded");
  MnvH2D* dataMnv = (MnvH2D*)f1.Get("h_data_Emu_Ehad_unfolded");
  ...
  //leg->AddEntry(" ","Lead of Target 3");
  leg->Draw("SAME");
    gc->Print(doMultipliers ? "nu-2d-unfolded-model-NT-Ehad-multiplier.png" : "nu-2d-unfolded-NT-model-Ehad.png");
  ...
  // Values to multiply each bin by to get them on a similar range
  double  multipliers4[]={3, 1, 1, 1.5, 3, 5, 7, 10, 15, 25,
			  100, 1, 1};
  ...
  gc2->Print(doMultipliers ? "nu-2d-unfolded-NT-model-Emu-multiplier.png" : "nu-2d-unfolded-NT-model-Emu.png");
