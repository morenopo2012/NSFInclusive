...
void makePlots(bool doMultipliers, bool doPrelimLabel = false)
{
  ...
  leg->Draw("SAME");
    gc->Print(doMultipliers ? "nu-2d-unfolded_ratios-NT-model-Ehad-multiplier.png" : "nu-2d-unfolded-ratios-NT-model-Ehad.png");
  ...
  gc2->Print(doMultipliers ? "nu-2d-unfolded-ratios-NT-model-Emu-multiplier.png" : "nu-2d-unfolded-ratios-NT-model-Emu.png");
