...
void makeplot(string histsuffix, TFile* myfile, bool doprelimlabel=false){
  ...
  PlotUtils::MnvH2D *num = (PlotUtils::MnvH2D*)myfile->Get("selected_mc_reco2d_x_Q2");
  PlotUtils::MnvH2D *dem = (PlotUtils::MnvH2D*)myfile->Get("selected_truth2d_reco_x_Q2");
