...
void makePlots(bool doMultipliers)
{
  ...
  TFile f1("/minerva/app/users/zdar/cmtuser/Minerva_v22r1p1_MADNew/Ana/NSFNukeCCInclusive/ana/make_hists/XSTest/Hists_EventSelection_t14_z82_Nu_minervame1D.root");//1track
  //need pzmuptmu
  ...
  //leg->AddEntry(" ","Lead of Target 3");
  leg->Draw("SAME");
    gc->Print(doMultipliers ? "nu-2d-Evtrate-Tracker-model-Ehad-multiplier.png" : "nu-2d-Evtrate-Tracker-model-Ehad.png");
  ...
  // Values to multiply each bin by to get them on a similar range
  double  multipliers4[]={3, 1, 1, 1.3, 2.8, 5, 7, 10, 15, 25,
			  50, 1, 1};
  ...
  gc2->Print(doMultipliers ? "nu-2d-Evtrate-model-Tracker-Emu-multiplier.png" : "nu-2d-Evtrate-model-Tracker-Emu.png");
