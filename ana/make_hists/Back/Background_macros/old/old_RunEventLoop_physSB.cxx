...
int main(int argc, char *argv[]){
   ...
   bool doDIS=false;
   const std::string mc_file_list("../../include/playlists/NukeCC_minervame1A_MC_Inextinguishable_merged_ABC.txt");
   const std::string data_file_list("../../include/playlists/NukeCC_minervame1A_DATA_Inextinguishable_merged_ABC.txt");
  ...
  //=========================================
   ...
   if(RunCodeWithSystematics){
       histFileName = utils->GetHistFileName( "PhysicsBackgd_with_SYS", FileType::kAny, targetID, targetZ, helicity ); 
     }
   else{
