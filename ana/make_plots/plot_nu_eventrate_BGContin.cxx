...
void makePlots(bool doMultipliers)
{
  ...
  TFile f1("/minerva/app/users/zdar/cmtuser/Minerva_v22r1p1_MADNew/Ana/NSFNukeCCInclusive/ana/make_hists/Hists_EventSelection_t2_z26_Nu.root");//1track
  //need pzmuptmu
 ...
 */
  ...
  MnvH2D* TinC=(MnvH2D*)f1.Get("selected_mc_trans_in_contin_Emu_Ehad");//Get from N track
  MnvH2D* CinC=(MnvH2D*)f1.Get("selected_mc_contin_in_contin_Emu_Ehad");//Get from N track
  MnvH2D* SinC=(MnvH2D*)f1.Get("selected_mc_signal_in_contin_Emu_Ehad");//Get from N track
  ...
  MnvH2D* CUS=(MnvH2D*)f1.Get("selected_contin_CH_US_Emu_Ehad");//Get from N track
  MnvH2D* CDS=(MnvH2D*)f1.Get("selected_contin_CH_DS_Emu_Ehad");//Get from N track
  
  MnvH2D* TData=(MnvH2D*)f1.Get("selected_data_trans_Emu_Ehad");//Get from N track
  MnvH2D* CData=(MnvH2D*)f1.Get("selected_data_contin_Emu_Ehad");//Get from N track
  ...
  CData->Scale(1e-3, "width");
  TinT->Scale(1e-3, "width");
  CinT->Scale(1e-3, "width");
  SinT->Scale(1e-3, "width");
  SinC->Scale(1e-3, "width");
  TinC->Scale(1e-3, "width");
  CinC->Scale(1e-3, "width");
  TUS->Scale(1e-3, "width");
  TDS->Scale(1e-3, "width");
  CUS->Scale(1e-3, "width");
  CDS->Scale(1e-3, "width");
