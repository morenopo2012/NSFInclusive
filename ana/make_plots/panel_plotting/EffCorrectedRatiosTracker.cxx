...
void makePlots(bool doMultipliers, bool doPrelimLabel = false)
{
  ...
  leg->Draw("SAME");
    gc->Print(doMultipliers ? "nu-2d-effCorr_ratios-Tracker-model-Ehad-multiplier.png" : "nu-2d-effCorr-ratios-Treacker-model-Ehad.png");
  ...
  gc2->Print(doMultipliers ? "nu-2d-effCorr-ratios-Tracker-model-Emu-multiplier.png" : "nu-2d-effCorr-ratios-Treacker-model-Emu.png");
