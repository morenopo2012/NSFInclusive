...
void makePlots(bool doMultipliers)
{
  ...
  //leg->AddEntry(" ","Lead of Target 3");
  leg->Draw("SAME");
    gc->Print(doMultipliers ? "nu-2d-unfolded-model-Ehad-multiplier.png" : "nu-2d-unfolded-model-Ehad.png");
  ...
  gc2->Print(doMultipliers ? "nu-2d-unfolded-model-Emu-multiplier.png" : "nu-2d-unfolded-model-Emu.png");
