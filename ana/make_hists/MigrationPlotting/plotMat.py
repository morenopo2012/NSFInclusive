...
targetZ = sys.argv[2]
playlist = sys.argv[3]
infile= ROOT.TFile("/minerva/app/users/zdar/cmtuser/Minerva_v22r1p1_MADNew/Ana/NSFNukeCCInclusive/ana/make_hists/XSTest/Hists_Migration_t%s_z%s_Nu_%s.root"%(targetID,targetZ,playlist),"READ")
