...
void makeplot(string histsuffix, TFile* myfile, bool doprelimlabel=false){
  ...
  //PlotUtils::MnvH2D *num = (PlotUtils::MnvH2D*)myfile->Get("selected_mc_reco2d_Emu_Ehad");
  //PlotUtils::MnvH2D *dem = (PlotUtils::MnvH2D*)myfile->Get("selected_truth2d_reco_Emu_Ehad");
  
  PlotUtils::MnvH2D *num = (PlotUtils::MnvH2D*)myfile->Get("selected_mc_reco2d_x_y");
  PlotUtils::MnvH2D *dem = (PlotUtils::MnvH2D*)myfile->Get("selected_truth2d_reco_x_y");
  ...
  num->GetXaxis()->SetTitle("True x ");
  num->GetYaxis()->SetTitle("True y ");
