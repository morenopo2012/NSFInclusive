       ...
       for (auto band : error_bands){
		 ...
		 reco0++;
                  //bool passes_cuts = true;
                     ...
                     cut_map_t passes_cuts = selection.isMCSelected(*universe, event, 1); //PassesCuts(*universe);
...
//	 NukeCC_Cuts     *cutter  = new NukeCC_Cuts();
	 ...
	 std::vector<Var2D*> variables2DMC,variables2DData; 
         ...
         PlotUtils::cuts_t<CVUniverse> sidebands = reco::getCCInclusiveCuts<CVUniverse>(targetID,targetZ,helicity,false),	
                                preCuts;
