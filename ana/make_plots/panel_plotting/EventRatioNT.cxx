...
void makePlots(bool doMultipliers, bool doPrelimLabel = false)
{
  ...
  leg->Draw("SAME");
    gc->Print(doMultipliers ? "nu-2d-evtrate-ratio-NT-model-Ehad-multiplier.png" : "nu-2d-evtrate-ratio-NT-model-Ehad.png");
  ...
  gc2->Print(doMultipliers ? "nu-2d-evtrate-ratio-NT-model-Emu-multiplier.png" : "nu-2d-evtrate-ratio-NT-model-Emu.png");
