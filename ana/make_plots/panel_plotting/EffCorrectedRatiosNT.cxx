...
void makePlots(bool doMultipliers, bool doPrelimLabel = false)
{
  ...
  leg->Draw("SAME");
    gc->Print(doMultipliers ? "nu-2d-effCorr_ratios-NT-model-Ehad-multiplier.png" : "nu-2d-effCorr-ratios-NT-model-Ehad.png");
  ...
  gc2->Print(doMultipliers ? "nu-2d-effCorr-ratios-NT-model-Emu-multiplier.png" : "nu-2d-effCorr-ratios-NT-model-Emu.png");
