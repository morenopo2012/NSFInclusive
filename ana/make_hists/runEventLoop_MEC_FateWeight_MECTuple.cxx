...
int main(int argc, char *argv[]){
    ...
    const std::string reco_tree_name("MECAna");
...
void FillVariable( PlotUtils::ChainWrapper* chain, HelicityType::t_HelicityType helicity, NukeCCUtilsNSF *utils , NukeCC_Cuts *cutter ,NukeCC_Binning  *binsDef ,std::vector<Var*>& variables,std::vector<Var2D*>& variables2d,bool isMC,int targetID, int targetZ, const string playlist, bool doDIS){
  ...
  variables = {emu, ehad, enu, vtxz};//{enu,ehad};
  ...
  for(int i=0; i<chain->GetEntries(); ++i){
	...
	//if(VetoWall_event_IsVeto ==1) continue; 
        ...
        int mc_resID;
        mc_resID = universe->GetInt("mc_resID");
        ...
        //std::cout<<"Fate Number "<<numFate<<std::endl;
        hist_fate_Number->Fill(counter);
        ...
        */
        ...
        for (auto v : variables2d){
          ...
          //Here I intent to add the new Histograms as function of the channel. 
    ...
    double Erecoil=universe->GetDouble("MECAna_recoil_E");
...
*/
          ...
          //std::cout<<"E avail is: "<< RecoEavail <<std::endl;
            ...
            std::cout<<"E avail is: "<< RecoEavail<< " Reco q3: " <<Recoq3 <<" Truth E avail: "<< EavaT << " recoilE_tracker_nom: " << recoilE_tracker_nom<<" recoilE_ecal_nom: " <<recoilE_ecal_nom <<std::endl;
