...
void makePlots(bool doMultipliers, bool doPrelimLabel = false)
{
  ...
  leg->Draw("SAME");
    gc->Print(doMultipliers ? "nu-2d-evtrate-model-ratio-Tracker-Ehad-multiplier.png" : "nu-2d-evtrate-model-ratio-Tracker-Ehad.png");
  ...
  gc2->Print(doMultipliers ? "nu-2d-evtrate-model-ratio-Tracker-Emu-multiplier.png" : "nu-2d-evtrate-model-ratio-Tracker-Emu.png");
