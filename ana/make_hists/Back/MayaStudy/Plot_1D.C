...
{
    TFile *f1 = TFile::Open("/minerva/data/users/zdar/MADHists/MayaStudy/Hists_EventSelection_t14_z82_Nu_v1_.root");
  ...
  //TH1F *h1_data = (TH1F*)f1->Get("sample_dis_Data_y_t1_z26");
  //TH1F *h1_data = (TH1F*)f2->Get("selected_data_reco_y");
  TH1F *h1_mc = (TH1F*)f1->Get("selected_mc_reco_Emu");
  TH1F *h1_data = (TH1F*)f1->Get("selected_data_reco_Emu");
