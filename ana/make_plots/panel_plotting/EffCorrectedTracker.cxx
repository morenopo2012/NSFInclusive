...
void makePlots(bool doMultipliers)
{
  ...
  //three files 1-track, 2+track, N-track
   ...
   TFile f1 ("/minerva/app/users/zdar/cmtuser/Minerva_v22r1p1_MADNew/Ana/NSFNukeCCInclusive/ana/make_hists/CrossSection_NSF/XS_pzmu_t14_z82.root");
  ...
  //leg->AddEntry(" ","Lead of Target 3");
  leg->Draw("SAME");
    gc->Print(doMultipliers ? "nu-2d-effCorrected-Tracker-model-Ehad-multiplier.png" : "nu-2d-effCorrected-Tracker-model-Ehad.png");
  ...
  gc2->Print(doMultipliers ? "nu-2d-effCorrected-Tracker-model-Emu-multiplier.png" : "nu-2d-effCorrected-Tracker-model-Emu.png");
