...
void makeplot(string histsuffix, TFile* myfile, bool doprelimlabel=false){
  ...
  PlotUtils::MnvH2D *num = (PlotUtils::MnvH2D*)myfile->Get("h_mc_Emu_EhaddataCrossSection");
  PlotUtils::MnvH2D *dem = (PlotUtils::MnvH2D*)myfile->Get("h_mc_Emu_Ehadqelike_recoCrossSection");
...
------"<<std::endl;
  ...
  TFile *infile = new TFile(Form("%s/XS_pzmu.root",location.c_str()));
