...
void makePlots(bool pt, string location, bool drawGroups, int areanorm)
{
  ...
  if(!drawGroups){
    ...
    if(pt){
      ...
      GridCanvas* gcPT=plotXAxis1DRebinPz(histsPT2D, "Emu (GeV)", "Ehad", 4,4,800,500,NULL);
      gcPT->SetYTitle("Fractional uncertainty");
      //gcPT->SetYLimits(0, 0.29);
      gcPT->SetYLimits(0, 0.7);
      ...
      GridCanvas* gcPT=plotYAxis1D(histsPT2D, "Emu (GeV)", "Ehad",4,4,800,500,NULL);
      gcPT->SetYTitle("Fractional uncertainty");
      //gcPT->SetYLimits(0, 0.29);
      gcPT->SetYLimits(0, 0.7);
      gcPT->Modified();
    ...
    for(int n=0;n<names.size();n++){
      ...
      if(pt){
	//GridCanvas* gcPT=plotXAxis1DRebinPz(histsPT2D, "P_{||} (GeV)", "P_{t}", 4,4,800,500,NULL);
	GridCanvas* gcPT=plotXAxis1DRebinPz(histsPT2D, "Ehad (GeV)", "Emu", 4,4,800,500,NULL);
	gcPT->SetYTitle("Fractional uncertainty");
