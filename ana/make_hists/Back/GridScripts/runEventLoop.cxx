...
int main(int argc, char *argv[]){
 ...
 if(argc==1){
  ...
  const std::string mc_file_list   = "playlists/" + plist_string + "MC.txt";
  const std::string data_file_list = "playlists/" + plist_string + "Data.txt";
...
for(auto band : error_bands){
  ...
  // std::cout<<"**********************************"<<std::endl;
   ...
   std::cout<<" All cuts 2D = "<<reco7<<std::endl;
   std::cout<<" All cuts 1D = "<<reco10<<std::endl;
   std::cout<<" Data All cuts 1D = "<<data0<<std::endl;
   std::cout<<"**********************************"<<std::endl;
   //	return variables;
}
//============================================================================================================================
