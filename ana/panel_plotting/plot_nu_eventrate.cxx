...
void makePlots(bool doMultipliers, bool doTracks, bool doBkgSub, string location)
{
  ...
  TFile f4(Form("%s_CV/MuonEventSelection_MakeFlux-1_Multiplicity-0_Sample-Signal_CombinedPlaylists.root",location.c_str()));//NTrack
  //Constraint File
  ...
  //GridCanvas* gc=plotXAxis1D(histAndOpts, "Muon Longitudinal Momentum (GeV/c)", "p_{t}", 4,4,800,500,doMultipliers ? &multipliers[0] : NULL);
  ...
  TLegend* leg=new TLegend(0.17, 0.8, 0.31, 0.9);
  leg->SetFillStyle(0);
  leg->SetBorderSize(0);
