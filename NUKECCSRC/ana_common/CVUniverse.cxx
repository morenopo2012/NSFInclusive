...
//double CVUniverse::GetThetamu()      const {return GetThetamu();}
...
double CVUniverse::GetMuonPt()       const{return GetMuonP()*sin(GetThetamu());}
double CVUniverse::GetMuonPz()       const{return GetMuon4V().Z();}
double CVUniverse::GetlepPtTrue()    const{return GetPlepTrue()*sin(GetThetalepTrue());}
...
//return W2Reco;
//This is a change added by Faiza// Why then calculate W?
